...
public class Tesselator {
	...
	public void Tesselate(Level level, GlRenderer renderer, WorldChunk chunk, int xOffset, int yOffset, int width, int height, TesselatorGroups tesselators, boolean makeFloors, boolean makeCeilings, boolean makeWalls, boolean makeUpperWalls, boolean makeLowerWalls, boolean showLights)
	{
        tesselators.clear();
                    ...
                    for(TileEdges dir : TileEdges.values()) {
                        ...
                        if (showWall) {
                            ...
                            if (isOtherSolid || isOtherEdgeVisible) {
                                ...
                                if (isOtherFloorHigher && makeLowerWalls) {
                                ...
                                if (isOtherCeilLower && !isOtherSky && makeUpperWalls) {
