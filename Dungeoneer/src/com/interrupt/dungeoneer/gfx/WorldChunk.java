...
public class WorldChunk {
    ...
    // Some controls for picking what to draw
	public boolean makeWalls = true;
    public boolean makeUpperWalls = true;
    public boolean makeLowerWalls = true;
	public boolean makeFloors = true;
	public boolean makeCeilings = true;
    ...
    public void renderAllForEditorPicker() {
        tesselators.world.render();
        tesselators.water.render();
        tesselators.waterfall.render();
    }
    ...
    public void Tesselate(Level level, GlRenderer renderer, boolean includeEntities) {
        tesselator.Tesselate(level, renderer, this, xOffset, yOffset, width, height, tesselators, makeFloors, makeCeilings, makeWalls, makeUpperWalls, makeLowerWalls, true);
        ...
        // Set drawing bounds
        Array<BoundingBox> calcedBounds = new Array<>();
        ...
        // Keep track of our static entities!
        if(includeEntities) {
        ...
        // Expand the bounding box to fit everything
    ...
    public TesselatorGroups getTesselators() {
        return tesselators;
    }
}
