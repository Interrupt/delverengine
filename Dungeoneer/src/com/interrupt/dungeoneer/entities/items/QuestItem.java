...
public class QuestItem extends Item {
	...
	protected void pickup(Player player)
	{
		...
		if(Game.instance.player.addToInventory(this))
		{
			...
			Game.message2.add(StringManager.get("items.QuestItem.noRoomText"), 1f);
		}
	}
	...
	public void doQuestThing() {
		...
		Game.message2.add(MessageFormat.format(StringManager.get("items.QuestItem.gotItemText"), GetName()), 8f);
