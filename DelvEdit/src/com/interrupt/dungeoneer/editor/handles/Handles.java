...
public class Handles {
    ...
    /** Return true if any handle is currently being manipulated. */
    public static boolean isActive() {
        return currentHoveredHandle != null;
    }
    ...
    public static void pick() {
        ...
        Handle hovered = get(index);

        if (hovered != null) {
            if (currentHoveredHandle != hovered) {
